...
public class NeoForgeMinecraftScreenUnit<C extends Role, D> extends MinecraftScreenUnit<C, D> {

    public NeoForgeMinecraftScreenUnit(@NotNull NexoMinecraft<?, ?, ?, ?> nexo, @NotNull ScreenBase<D> feature, @Nullable C role, @NotNull MinecraftScreen.ScreenCrafter crafter) {
        super(nexo, feature, role, crafter);
    }

    public NeoForgeMinecraftScreenUnit(@NotNull NexoMinecraft<?, ?, ?, ?> nexo, @NotNull ScreenBase<D> feature, @Nullable C role, @NotNull MinecraftScreen.ScreenCrafter crafter, @NotNull Screen screen) {
